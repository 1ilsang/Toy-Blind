                ...
                <div class="article seo modify">
                    <div class="tit_area">
                        <label>
                            <h1>
                                <input
                                        style="line-height: 40px; width: 250px"
                                        type="text"
                                        :value="post.title"
                                        required
                                        @input="modifyTitle=$event.target.value"
                                ></h1>
                        </label>
                        <div class="writer">
                            <div><span>{{ post.company }}</span>
                                <span><span slot="reference"><a><span
                                        class="name"
                                >{{ post.nickname }}</span></a></span></span>
                            </div>
                        </div>
                        <div class="tit_info">
                            <span
                                    :title="post.u_created"
                                    class="date"
                            >{{ post.u_created | convertDateToMonthDay }}</span>
                        </div>
                        <div v-if="getUserData.seq === post.user_seq" class="article_func">
                            <ul>
                                <li>
                                    <div
                                            class="btn_close"
                        ...
                        <label>
                            <h1>
                                <input
                                        ...
                                        required
                                        @input="modifyDescription=$event.target.value"
                                ></h1>
                        </label>
        ...
        <div class="wrap_topic" v-if="!modifyMode">
            <section class="topic_view">
                ...
                <div class="topic_comments">
                    ...
                    <LoginPop v-if="!Boolean(getUserData.nickname)"/>
                    <ListCardComments
                            :comments="comments"
                            :total-comments-cnt="this.post.comments"
                            :board-seq="boardSeq"
                            @deleteComment="deleteComment"
                            @updateReplyComments="updateReplyComments"
                    />
