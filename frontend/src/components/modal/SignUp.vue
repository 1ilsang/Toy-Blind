<template>
    ...
    <div class="ly_signup">
        <div class="top_area">
            <h2 v-if="phase===1" class="tit">Join Blind!</h2>
            <h2 v-if="phase===2" class="tit">Check your email</h2>
        ...
        <div class="contents">
            <div class="desc">
                ...
                <div v-if="phase===2">
                    <p>
                        Enter the verification code we sent to <br class="is_mobile">
            ...
            <div v-if="phase===1" class="usrform_wrap siginin">
